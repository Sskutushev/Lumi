...
const ProjectView: React.FC<ProjectViewProps> = ({ project, onBack }) => {
  ...
  const projectTasks = [
    { id: '1', title: 'Task 1 in project', completed: true, priority: 'high', dueDate: '2025-02-15' },
    { id: '2', title: 'Task 2 in project', completed: false, priority: 'medium', dueDate: '2025-02-20' },
    { id: '3', title: 'Task 3 in project', completed: false, priority: 'low', dueDate: '2025-02-25' },
  ];
